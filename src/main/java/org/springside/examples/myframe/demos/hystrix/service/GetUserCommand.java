 ...
 *******************************************************************************/
package org.springside.examples.myframe.demos.hystrix.service;
...
public class GetUserCommand extends HystrixCommand<UserDTO> {
	...
	protected UserDTO run() throws Exception {
		try {
			...
			return restTemplate.getForObject("http://localhost:8080/myframe/hystrix/resource/{id}", UserDTO.class, id);
