 ...
 *******************************************************************************/
package org.springside.examples.myframe.service;
...
import org.springside.examples.myframe.demos.jms.simple.NotifyMessageProducer;
import org.springside.examples.myframe.demos.jmx.ApplicationStatistics;
import org.springside.examples.myframe.entity.Role;
import org.springside.examples.myframe.entity.User;
import org.springside.examples.myframe.repository.jpa.RoleDao;
import org.springside.examples.myframe.repository.jpa.UserDao;
import org.springside.examples.myframe.service.ShiroDbRealm.ShiroUser;
...
public class AccountService {
	...
	public void saveRole(Role role) {
		...
		// 业务日志演示
		Map logData = Maps.newHashMap();
		logData.put("roleId", role.getId());
		businessLogger.log("ROLE", "UPDATE", getCurrentUserRole(), logData);
	}
	...
	public List<Role> searchRole(Map<String, Object> searchParams) {
		...
		// 业务日志演示
		if (businessLogger != null) {
			businessLogger.log("ROLE", "LIST", getCurrentUserRole(), null);
		}
		return roleList;
	}
