 ...
 *******************************************************************************/
package org.springside.examples.myframe.webservice.soap;
...
import org.springside.examples.myframe.entity.Team;
import org.springside.examples.myframe.entity.User;
import org.springside.examples.myframe.service.AccountEffectiveService;
import org.springside.examples.myframe.webservice.soap.response.GetTeamDetailResult;
import org.springside.examples.myframe.webservice.soap.response.GetUserResult;
import org.springside.examples.myframe.webservice.soap.response.SearchUserResult;
import org.springside.examples.myframe.webservice.soap.response.base.IdResult;
import org.springside.examples.myframe.webservice.soap.response.base.WSResult;
import org.springside.examples.myframe.webservice.soap.response.dto.TeamDTO;
import org.springside.examples.myframe.webservice.soap.response.dto.UserDTO;
...
@WebService(serviceName = "AccountService", endpointInterface = "org.springside.examples.myframe.webservice.soap.AccountSoapService", targetNamespace = WsConstants.NS)
