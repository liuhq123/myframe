		...
		<div class="container">
			<div class="navbar-brand">
				...
				<a href="${ctx}/cloud/index.html"> <img
					src="${ctx}/cloud/img/logo/logo.png" alt="Cloud Admin Logo"
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown" id="header-message"><a href="#"
					...
					<ul class="dropdown-menu inbox">
						...
						<li><a href="#"> <img
								src="${ctx}/cloud/img/avatars/avatar2.jpg" alt="" /> <span
						...
						<li><a href="#"> <img
								src="${ctx}/cloud/img/avatars/avatar1.jpg" alt="" /> <span
								class="body"> <span class="from">Vince Pelt</span> <span
									class="message"> Duis autem vel eum iriure dolor in
										hendrerit in vulputate velit esse mole ... </span> <span class="time">
										<i class="fa fa-clock-o"></i> <span>15 min ago</span>
								</span>
							</span>

						</a></li>
						<li><a href="#"> <img
								src="${ctx}/cloud/img/avatars/avatar8.jpg" alt="" /> <span
								class="body"> <span class="from">Debby Doe</span> <span
									class="message"> Duis autem vel eum iriure dolor in
										hendrerit in vulputate velit esse mole ... </span> <span class="time">
										<i class="fa fa-clock-o"></i> <span>2 hours ago</span>
								</span>
							</span>
				...
				<li class="dropdown user" id="header-user"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img alt=""
						src="${ctx}/cloud/img/avatars/avatar3.jpg" /> <span
						class="username">John Doe</span> <i class="fa fa-angle-down"></i>
				</a>
				...
				<li><shiro:guest>
					...
					</shiro:guest> <shiro:user>您好, <shiro:principal property="name" />
			...
			<div id="teamslider">
				<ul class="team-list">
					<li class="current"><a href="javascript:void(0);"> <span
							class="image"> <img
								src="${ctx}/cloud/img/avatars/avatar3.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/cloud/img/avatars/avatar1.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/cloud/img/avatars/avatar2.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/cloud/img/avatars/avatar4.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/cloud/img/avatars/avatar5.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/cloud/img/avatars/avatar6.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/cloud/img/avatars/avatar7.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/cloud/img/avatars/avatar8.jpg" alt="" />
