								...
								.validate(
										{
											rules : {
												loginName : {
													remote : "${ctx}/account/user/checkLoginName?oldLoginName="
...
<body>
	...
	<form:form id="inputForm" modelAttribute="user"
		action="${ctx}/account/user/update" method="post"
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="loginName" name="loginName"
						value="${user.loginName}" class="input-large required" />
				</div>
			</div>
			<div class="control-group">
				<label for="name" class="control-label">中文名:</label>
				<div class="controls">
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:bscheckboxes path="roleList" items="${allRoles}"
