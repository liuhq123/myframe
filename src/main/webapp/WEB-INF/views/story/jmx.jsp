...
<body>
	...
	<h2>MBean介绍</h2>
	<ul>
		<li>Application Statistics Mbean, 当用户在综合演示里查看/更新用户时，计数器将会递增, name为myframe:name=ApplicationStatistics</li>
	...
	查询：
	<ul>
		<li>列出myframe域下的所有MBean及其描述: <br/><a href="${baseUrl}/jolokia/list/myframe">/jolokia/list/myframe</a></li>
		<li>获取myframe域下的所有MBean的属性: <br/><a href="${baseUrl}/jolokia/read/myframe:name=*">/jolokia/read/myframe:name=*</a></li>
		<li>获取应用统计MBean的所有属性: <br/><a href="${baseUrl}/jolokia/read/myframe:name=ApplicationStatistics">/jolokia/read/myframe:name=ApplicationStatistics</a></li>
		<li>只获取应用统计MBean的展示用户列表次数属性: <br/><a href="${baseUrl}/jolokia/read/myframe:name=ApplicationStatistics/ListUserTimes">/jolokia/read/myframe:name=ApplicationStatistics/ListUserTimes</a></li>
	</ul>
	设置：
	<ul>
	...
	执行：
	<ul>
		<li>执行重置清零统计信息的命令: <br/><a href="${baseUrl}/jolokia/exec/myframe:name=ApplicationStatistics/resetStatistics">/jolokia/exec/myframe:name=ApplicationStatistics/resetStatistics</a></li>
