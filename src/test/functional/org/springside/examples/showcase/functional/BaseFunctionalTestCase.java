 ...
 *******************************************************************************/
package org.springside.examples.myframe.functional;
...
import org.springside.examples.myframe.MyframeServer;
...
public class BaseFunctionalTestCase {
	...
	protected static void startJettyOnce() throws Exception {
		if (jettyServer == null) {
			...
			jettyServer = JettyFactory.createServerInSource(new URL(baseUrl).getPort(), MyframeServer.CONTEXT);
			JettyFactory.setTldJarNames(jettyServer, MyframeServer.TLD_JAR_NAMES);
			jettyServer.start();
